"""This module contains an simple Autoencoder model for Fashion-MNIST"""
...
class AutoEncoder(nn.Module):
  ...
  def forward(self, image: T.Tensor) -> vae_generic.VAEOutput:
    ...
    # let's make it a sparse autoencoder
    return vae_generic.VAEOutput(
        prediction,
        T.sqrt(self.loss(image, prediction)) + 0.0001 * T.norm(z, 1))
